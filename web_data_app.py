...
@app.route("/learn")
def learn():
    # Return a string that describes one thing I learned in ENSF 692.
    return "ENSF 692 introduced me to Pandas. Everything from creating a DataFrame, to manipulating it, to plotting it was all new to me. "
    pass
